...
include::_repeaters/repeaters_1.adoc[]

=== The ListView Component
include::_repeaters/repeaters_2.adoc[]

=== The RefreshingView Component
include::_repeaters/repeaters_3.adoc[]

=== Pageable repeaters
include::_repeaters/repeaters_4.adoc[]

=== Summary
include::_repeaters/repeaters_5.adoc[]
