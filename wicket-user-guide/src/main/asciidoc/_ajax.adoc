...
include::_ajax/ajax_1.adoc[]

=== Build-in AJAX components
include::_ajax/ajax_2.adoc[]

=== Built-in AJAX behaviors
include::_ajax/ajax_3.adoc[]

=== Using an activity indicator
include::_ajax/ajax_4.adoc[]

=== AJAX request attributes and call listeners
include::_ajax/ajax_5.adoc[]

=== Creating custom AJAX call listener
include::_ajax/ajax_6.adoc[]

=== Summary
include::_ajax/ajax_7.adoc[]
